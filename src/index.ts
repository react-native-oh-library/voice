...
} from '@react-native-voice/voice/src/VoiceModuleTypes';

const Voice = TurboModuleRegistry
  ? TurboModuleRegistry.get('VoiceNativeModule')
  : (NativeModules.Voice as VoiceModule);
